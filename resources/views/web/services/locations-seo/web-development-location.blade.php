...
@endphp
    ...
    <section class="hero webdev-hero" id="hero">
        ...
        <div class="container hero-content">
            ...
            <h1>
          {!! str_replace('|', '<br>', $hero['title'] ?? 'Professional Website Development Services <br>for Modern Businesses') !!}
        </h1>
                <p class="hero-subtitle">
                       {{ $hero['subtitle'] ?? 'Cloud Technologies Ltd provides professional website development services that help modern businesses
                    stand out with fast,
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/webdev/website-development/webdev-service.webp') }}" alt="Digital Marketing Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/webdev/website-development/web-dev.webp') }}" alt="Digital Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/webdev/website-development/cloud-web-dev.webp') }}" alt="Affordable Services">
            </div>
