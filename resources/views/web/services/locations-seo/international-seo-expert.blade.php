...
@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/services/digitalMarketing/international-seo-expert-uk/css/style.css') }}">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/services/digitalMarketing/international-seo-expert-uk/js/script.js') }}" defer></script>
@endpush
