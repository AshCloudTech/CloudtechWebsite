...
@endphp
    ...
    <section class="hero gmb-hero" id="hero">
        ...
        <div class="container hero-inner">
            ...
            <h1>{!! str_replace('|', '<br>', $hero['title'] ?? 'Google Business Profile Growth Services') !!}</h1>
                <p class="hero-subtitle">
                    {{ $hero['subtitle'] ?? 'Optimize your listing to improve local visibility, gain more clicks, and attract nearby customers.'}}'
                </p>
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/digitalmark/google-business.webp') }}" alt="Digital Marketing Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/digitalmark/google-business-profile.webp') }}" alt="Digital Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/digitalmark/googlebusiness.webp') }}" alt="Affordable Services">
            </div>
