...
@endphp
    ...
    <section class="hero php-hero" id="hero">
        <div class="container hero-inner">
            ...
            <h1>{!! str_replace('|', '<br>', $hero['title'] ?? 'Bespoke PHP Projects<br>Built for Your Business') !!}</h1>
            <p class="hero-subtitle">
                {{ $hero['subtitle'] ?? 'When you need full ownership, framework-agnostic flexibility and deep integrations, custom PHP
    ...
    <section class="section section-related-links" id="related-services">
        <div class="container">
            <div class="section-header">
                ...
                <p>Combine custom PHP builds with development and SEO services for stronger long-term growth.</p>
            </div>

            <div class="related-links-grid">
                <a class="related-link-card" href="/laravel-website-development-service-uk"
                    aria-label="Laravel development UK">
                    <span>Laravel Development UK</span>
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/webdev/php.webp') }}" alt="Digital Marketing Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/webdev/phpdevelopment.webp') }}" alt="Digital Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/webdev/customphp.webp') }}" alt="Affordable Services">
            </div>
