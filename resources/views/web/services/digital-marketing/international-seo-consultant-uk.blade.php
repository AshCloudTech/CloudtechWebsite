...
@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/services/digitalMarketing/international-seo-consultant-uk/css/style.css') }}">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/services/digitalMarketing/international-seo-consultant-uk/js/script.js') }}" defer></script>
@endpush
