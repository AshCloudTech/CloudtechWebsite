...
@php
    ...
    // Helper to mark a group open if any child route is active
...
@php
  $websiteOpen = isGroupActive([
      ...
      'admin.leads.*',
      'admin.case-studies.*', // if you add it
  ]);
@endphp
...
<div class="navSection">
    ...
    <div class="navGroupPanel {{ $websiteOpen ? 'open' : '' }}" data-nav-panel="website">
        <nav class="nav navNested">
            ...
            {{-- Example future --}}
            <a class="{{ request()->routeIs('admin.case-studies.*') ? 'active' : '' }}" href="{{ route('admin.case-studies.index') }}">
