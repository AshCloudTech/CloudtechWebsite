...
@endphp
    ...
    <section class="hero wix-hero" id="hero">
      ...
      <h1>{!! str_replace('|', '<br>', $hero['title'] ?? 'High-Performance Wix<br>Website Development Services') !!}</h1>
            <p class="hero-subtitle">
                 {{ $hero['subtitle'] ?? 'We provide professional Wix website development services to build scalable,
    ...
    <section class="section section-related-links" id="related-services">
        <div class="container">
            <div class="section-header">
                ...
                <p>Connect your Wix website with development and SEO services that support long-term growth.</p>
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/webdev/wix/cloud-wix.webp') }}" alt="Digital Marketing Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/webdev/wix/wix-service.webp') }}" alt="Digital Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/webdev/wix/wix-dev.webp') }}" alt="Affordable Services">
            </div>
