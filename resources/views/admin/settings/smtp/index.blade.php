...
@section('content')
    <div class="btnRow" style="margin-bottom:12px;">
        <a class="btn primary" href="{{ route('admin.settings.smtp.create') }}">Add SMTP</a>
    </div>
                    ...
                    @forelse($mailers as $m)
                        <tr>
                            ...
                            <td style="display:flex;gap:8px;justify-content:flex-end;">
                                <a class="btn" href="{{ route('admin.settings.smtp.show', $m) }}">View</a>
                                <a class="btn" href="{{ route('admin.settings.smtp.edit', $m) }}">Edit</a>

                                <form method="POST" action="{{ route('admin.settings.smtp.destroy', $m) }}"
                                    style="margin:0;"
