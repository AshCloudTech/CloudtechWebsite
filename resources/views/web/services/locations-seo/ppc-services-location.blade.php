...
@endphp
    ...
    <section class="hero ppc-hero" id="hero">
        ...
        <div class="container hero-grid">
           ...
           <h1>{!! str_replace('|', '<br>', $hero['title'] ?? 'High-Performance PPC Campaigns That Convert') !!}</h1>
                <p class="hero-subtitle">
                    {{ $hero['subtitle'] ?? 'Launch and scale paid campaigns across Google, Microsoft and social platforms with a sharp focus on
...
@if(!empty($content['comparison']))
<section class="section dm-comparison-section">
    <div class="container">
        ...
        <div class="dm-comparison-grid">
            ...
            @foreach($content['comparison']['items'] as $item)
                <div class="dm-comparison-card">

                    <div class="dm-comparison-icon">
                        <i class="ri-building-line"></i>
                    </div>

                    <p class="dm-comparison-text">
                        {{ $item }}
                    </p>
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/digitalmark/ppc-service.webp') }}" alt="Digital Marketing Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/digitalmark/ppc-management.webp') }}" alt="Digital Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/digitalmark/ppc-cloudtech.webp') }}" alt="Affordable Services">
            </div>
