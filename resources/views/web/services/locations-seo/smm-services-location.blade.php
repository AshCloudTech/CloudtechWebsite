...
@endphp
    ...
    <section class="hero smm-hero" id="hero">
        ...
        <div class="container hero-grid">
            ...
            <h1>{!! str_replace('|', '<br>', $hero['title'] ?? 'Social Media Marketing Services') !!}</h1>
                <p class="hero-subtitle">
                    {{ $hero['subtitle'] ?? 'Boost your brand visibility engage your audience and drive real business results with strategic social
    ...
    <section class="section section-related-links" id="related-services">
        <div class="container">
            <div class="section-header">
                ...
                <p>Discover connected digital services that support faster traffic, leads, and revenue growth.</p>
            </div>

            <div class="related-links-grid">
                <a class="related-link-card" href="/digital-marketing-service-uk" aria-label="Digital marketing services UK">
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/digitalmark/socialmedia-marketing.webp') }}" alt="Digital Marketing Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/digitalmark/best-social-media-marketing.webp') }}" alt="Digital Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/digitalmark/social-media-marketing.webp') }}" alt="Affordable Services">
            </div>
