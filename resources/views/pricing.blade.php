...
@section('title', 'Pricing | Digital Marketing, SEO & Web Development UK')
@section('meta_title', 'Pricing | Digital Marketing, SEO & Web Development UK')
@section('meta_description', 'Explore our pricing for SEO, web development and digital marketing services. Affordable
    plans designed to grow your traffic, leads and sales UK.')
@section('meta_keywords', 'pricing, SEO pricing, web development pricing, digital marketing pricing, UK, affordable plans, business growth')
    @push('styles')
        ...
        <div class="container">
            <div class="prHero__grid">
                <div class="prHero__copy fx-reveal reveal-up">
                    ...
                    <p class="prSubtitle">
                        Choose a plan based on scope and speed. We focus on clean builds, SEO-friendly structure, and Core
                        Web Vitals.
                    </p>
        ...
        <div class="container">
            ...
            <header class="prSectionHead fx-reveal reveal-up">
                <div class="prSectionHead__grid">
                    <div class="prSectionHead__copy">
                        ...
                        <p class="prP">
                            Transparent deliverables, clean scope, and clear next steps. Pick a plan — we can tailor it
                            after discovery.
                        </p>
                    </div>
                    ...
                    <div class="prBilling">
                        <div class="prToggle" role="tablist" aria-label="Billing options">
                            <button class="toggleBtn active" data-billing="monthly" type="button" role="tab"
                                aria-selected="true">
                                Monthly
                            </button>
                            <button class="toggleBtn" data-billing="one-time" type="button" role="tab"
                                aria-selected="false">
                                One-Time
                            </button>
                        </div>
                        ...
                        <div class="prMiniNote">
                            <strong>Tip:</strong> Monthly works best for continuous growth & support. One-time is ideal for
                            fixed builds.
                        </div>
            ...
            <div class="prGrid" id="pricingGrid">
             ...
             Keep "price-card", "price", "sub" classes for toggle JS compatibility --}}
                    <article class="price-card prCard {{ $isFeatured ? 'isFeatured' : '' }} fx-reveal reveal-up"
                        data-plan="{{ $plan->key }}">
                        @if ($isFeatured)
                        ...
                        <div class="prPriceWrap">
                            <div class="price prPrice" data-monthly="{{ $mCur }}{{ $mAmt }}"
                                data-onetime="{{ $oCur }}{{ $oAmt }}">
                                {{ $mCur }}{{ $mAmt }}
                            </div>

                            <div class="sub prSub" data-monthly="{{ $mPer }}" data-onetime="{{ $oPer }}">
                                {{ $mPer }}
                            </div>
                        </div>
