    ...
    <section class="hero content-hero" id="hero">
        ...
        <div class="container hero-grid">
            <div class="hero-text">
                ...
                <h1> {!! str_replace('|', '<br>', $hero['title'] ?? 'Unlock Growth Through Strategic Content Marketing Services') !!}</h1>
                <p class="hero-subtitle">
                      {{ $hero['subtitle'] ?? 'Boost your brand with expert content SEO services from leading content marketing agencies and companies,
                    delivering a results-driven content marketing strategy for growth.' }}</p>
                </p>
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/seo/content/content-seo.webp') }}" alt="Content Seo Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/seo/content/content-services.webp') }}" alt="Content Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/seo/content/cloudtech-content.webp') }}" alt="Affordable Services">
            </div>
