...
@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/services/digitalMarketing/seo-international-sites-uk/css/style.css') }}">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/services/digitalMarketing/seo-international-sites-uk/js/script.js') }}" defer></script>
@endpush
