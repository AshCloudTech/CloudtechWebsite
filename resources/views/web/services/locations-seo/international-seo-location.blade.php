        ...
        <div class="container hero-content">
            <div class="hero-text">
                <p class="hero-eyebrow">International SEO Services</p>
                  <h1> {!! str_replace('|', '<br>', $hero['title'] ?? 'International SEO Services That <br>Grow Your Business Globally') !!}</h1>
                <p class="hero-subtitle">
                     {{ $hero['subtitle'] ?? 'Expand your reach across international markets with powerful, results-driven International SEO Services
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/seo/international/international-seo.webp') }}" alt="International Seo Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/seo/international/cloudtech-seo.webp') }}" alt="International Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/seo/international/seo-service.webp') }}" alt="Affordable Services">
            </div>
