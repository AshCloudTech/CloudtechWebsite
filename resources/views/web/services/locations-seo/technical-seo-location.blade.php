        ...
        <div class="container hero-grid">
            <div class="hero-text">
                <p class="hero-eyebrow">Technical SEO Services</p>
                  <h1> {!! str_replace('|', '<br>', $hero['title'] ?? 'Expert Technical SEO Services for Higher Search Rankings') !!}</h1>
                <p class="hero-subtitle">
                      {{ $hero['subtitle'] ?? 'Our Technical SEO Services optimize your site’s structure, speed, and crawlability to boost search
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/seo/technical/seo-service.webp') }}" alt="Technical SEO  Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/seo/technical/technical-seo.webp') }}" alt="Technical Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/seo/technical/technical_seo_services.webp') }}" alt="Affordable Services">
            </div>
