...
<section class="hero dm-hero" id="hero">
    ...
    <div class="container hero-content">
        ...
        <h1>
    {!! str_replace('|', '<br>', $hero['title'] ?? 'Digital Marketing Agency & Advertising Experts Transforming Your Online Presence') !!}
</h1>

            <p class="hero-subtitle">
                {{ $hero['subtitle'] ?? 'Cloud Technologies Ltd is a leading digital marketing and advertising agency delivering data-driven strategies, targeted campaigns, and innovative solutions to help businesses strengthen their online presence and achieve measurable growth.' }}
            </p>

         

            <div class="hero-actions">
                <a href="/contact-us" class="btn btn-lg btn-primary">Get Free Consultation</a>
                <a href="#services" class="btn btn-lg btn-ghost hero-ghost-light">Explore Services</a>
            </div>

            {{-- KEEP STATIC (design consistency) --}}
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/digitalmark/marketing.webp') }}" alt="Digital Marketing Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/digitalmark/digi-marketing.webp') }}" alt="Digital Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/digitalmark/cloud-digital-marketing.webp') }}" alt="Affordable Services">
            </div>
