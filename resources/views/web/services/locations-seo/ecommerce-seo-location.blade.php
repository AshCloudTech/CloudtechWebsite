        ...
        <div class="container hero-grid">
            <div class="hero-text">
                <p class="hero-eyebrow">eCommerce SEO Services</p>
                  <h1> {!! str_replace('|', '<br>', $hero['title'] ?? 'Grow Your Online Store with eCommerce SEO') !!}</h1>
                <p class="hero-subtitle">
                      {{ $hero['subtitle'] ?? 'Improve product visibility, attract high-intent shoppers, and increase revenue with a practical,
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/seo/ecommerce/seo-service.webp') }}" alt="Ecommerce Seo Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/seo/ecommerce/e-com_seo.webp') }}" alt="Ecommerce Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/seo/ecommerce/cloudtech-seo.webp') }}" alt="Affordable Services">
            </div>
