...
@endphp
    ...
    <section class="hero laravel-hero" id="hero">
        <div class="container hero-inner">
         ...
         <h1>{!! str_replace('|', '<br>', $hero['title'] ?? 'Scalable Laravel Web Development<br>Services') !!}</h1>
            <p class="hero-subtitle">
                  {{ $hero['subtitle'] ?? 'We provide professional Laravel development services, delivering secure, scalable,
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/webdev/laravel/laravel-service.webp') }}" alt="Digital Marketing Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/webdev/laravel/laravel-cloud.webp') }}" alt="Digital Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/webdev/laravel/laravel-dev.webp') }}" alt="Affordable Services">
            </div>
