...
@endphp
    ...
    <section class="hero seo-hero" id="hero">
        <div class="container hero-inner">
            ...
            <h1>
                  {!! str_replace('|', '<br>', $hero['title'] ?? 'SEO Services for Businesses Across the UK') !!}</h1>
               <p class="hero-subtitle">
            {{ $hero['subtitle'] ?? 'Struggling to get noticed on Google? We help businesses across the UK rank on the first page with affordable, results-driven SEO services tailored for companies of all sizes and industries.' }}
        </p>
            <!-- <p class="hero-subtitle">
    ...
    <div class="container">
        ...
        <div class="dm-complete-grid">
            ...
            <div class="dm-complete-right">
                <img src="{{ asset('assets/images/seo/seo-services-cloudtech.webp') }}" alt="SEO Services">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-insight-grid">
            ...
            <div class="dm-insight-media">
                <img src="{{ asset('assets/images/seo/seo-cloudtech.webp') }}" alt="SEO Strategy">
            </div>
    ...
    <div class="container">
        ...
        <div class="dm-affordable-grid">
            ...
            <div class="dm-affordable-media">
                <img src="{{ asset('assets/images/seo/cloudtech-seo.webp') }}" alt="Affordable Services">
            </div>
